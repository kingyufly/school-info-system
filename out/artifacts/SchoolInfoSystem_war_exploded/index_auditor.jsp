...
<ul id="myTab" class="nav nav-tabs">
    <li class="active">
        <a href="#searchRegulation" data-toggle="tab">
            Search for Regulations and Courses
        </a>
    </li>
    <li>
            ...
            <table border="1" width="90%">
                <%
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        Map map = (Map) list.get(i);
                        out.print("<tr>");
                        out.print("<td><a href=\"moreRegulation.jsp?chapter_id=" + map.get("chapter_id") + "\" target=>" + map.get("chapter_id") + "</a></td>");
                        String content = "" + map.get("content");
                        if(content.equals("view picture")){
                            ...
                            out.print("<td>" + content.substring(0,beginIndex) + "<a href=\"moreRegulation.jsp?chapter_id=" + map.get("chapter_id") + "\">...</a></td>");
                        }
//                        if ((content.indexOf(".jpg") != -1) || (content.indexOf(".JPG") != -1)) {
//                            out.print("<td><img src=" + content + " width=\"100%\" height=\"100%\"></td>");
//                        } else {
